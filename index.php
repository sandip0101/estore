		...
		<div class="spec ">
				...
				<div class=" tab-content tab-content-t ">
							...
							<div class="col-md-3 m-wthree">
								...
								<div class="col-m">								
									<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="../admin/upload/<?php echo $p->photo;?>" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html"><?php echo $p->name;?></a></h6>							
										</div>
										<div class="mid-2">
											<p ><label><?php echo $p->offprice;?></label><em class="item_price"><?php echo $p->price;?></em></p>
											  <div class="block">
					...
					<form method="post">
						...
						<input class="btn btn-danger"type ="number" name="qty" min="1" max="10" value="1"  >
						<button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="images/of.png" name="cart">Add to Cart</button>
					 </form>
										</div>
