		...
		<div class="container">
			...
			<div class="head-t">
				<ul class="card">
					...
					<li><a href="http://localhost/estore/user/login" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
					<li><a href="http://localhost/estore/user/register" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li><a href="http://localhost/estore/user/contact" class="hyper"><span>Contact Us</span></a></li>
						</ul>
					</div>
					</nav>
					 <div class="cart" >
